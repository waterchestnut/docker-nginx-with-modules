...
ARG modules=https://github.com/simplresty/ngx_devel_kit.git:v0.3.3,https://github.com/openresty/echo-nginx-module.git,https://github.com/openresty/lua-nginx-module.git:v0.10.28,https://github.com/vozlt/nginx-module-vts.git:v0.2.4
RUN set -x \
